...
class InHouseFuelRefillScreen extends StatefulWidget {
  final int vehicleId;
  final String vehicleName;
  final double availableQty;
  final String customerName;

  const InHouseFuelRefillScreen({
    Key? key,
  ...
  @override
  State<InHouseFuelRefillScreen> createState() =>
      _InHouseFuelRefillScreenState();
}

class _InHouseFuelRefillScreenState extends State<InHouseFuelRefillScreen> {
