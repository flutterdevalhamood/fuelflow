...
class RefillingUnitDetailScreen extends StatefulWidget {
  final Map<String, dynamic> data;

  const RefillingUnitDetailScreen({super.key, required this.data});

  @override
  State<RefillingUnitDetailScreen> createState() =>
      _RefillingUnitDetailScreenState();
}

class _RefillingUnitDetailScreenState extends State<RefillingUnitDetailScreen>
